...
var $author$project$Tests$update = F2(
	function (msg, model) {
		return model;
	});
...
var $author$project$Tests$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Tests$main = $elm$browser$Browser$sandbox(
	{init: 0, update: $author$project$Tests$update, view: $author$project$Tests$view});
...
var $author$project$Tests$tests = A2(
	...
	_List_fromArray(
		[
			...
			A2(
			$elm_explorations$test$Test$test,
			'Check if button element is present',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2(
...
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$Tests$main),
...
var pipeFilename = "/tmp/elm_test-3774.sock";
var net = require('net'),
